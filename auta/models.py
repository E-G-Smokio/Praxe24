...
class AutaModel(models.Model):
    ...
    autoOblazek = models.ImageField(upload_to='images/', height_field=None, width_field=None, max_length=None,
                                    default='')
...
class Vypujcka(models.Model):
    id_vypujcky = models.UUIDField(default=uuid.uuid4, unique=True, primary_key=True, editable=False)
